...
BirthcakeRebaked.BirthcakeAccurateBlurbs = {
	[PlayerType.PLAYER_ISAAC] = { 					-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_MAGDALENE] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_CAIN] = { 					-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_JUDAS] = { 					-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_BLUEBABY] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_EVE] = { 					-- EN: [X] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_SAMSON] = { 					-- EN: [OK] | RU: [OK] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_AZAZEL] = { 					-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_LAZARUS] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_EDEN] = { 					-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_KEEPER] = { 					-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_APOLLYON] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_THEFORGOTTEN] = { 			-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_BETHANY] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_JACOB] = { 					-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_MAGDALENE_B] = { 			-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_CAIN_B] = { 					-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_BLUEBABY_B] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_EVE_B] = { 					-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [X] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_SAMSON_B] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
		...
		pt_br = "Terminar salas talvez extenda Berserk + darão um coração",
		ko_kr = "방 클리어 시 폭주 지속 시간이 증가하고 빨간 하트를 생성할 수도 있음",
	},
	[PlayerType.PLAYER_AZAZEL_B] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_LAZARUS_B] = { 				-- EN: [OK] | RU: [!] | SPA: [X] | CS_CZ: [X] | PL: [X] | KO_KR [OK] | PT_BR [OK]
		...
		pt_br = "Trocar o item talvez dividirá ambos os lados",
		ko_kr = "아이템에 뒤집기 사용 시 이따금씩 아이템 2개로 분리됨",
	},
	[PlayerType.PLAYER_EDEN_B] = { 					-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_THELOST_B] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [X] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_LILITH_B] = { 				-- EN: [OK] | RU: [OK] | SPA: [X] | CS_CZ: [X] | PL: [X] | KO_KR [OK] | PT_BR [OK]
		...
		pt_br = "Chance de invocar outro Gello ao dar luz",
		ko_kr = "젤로 투척 시 일정 확률로 젤로 1명이 추가로 튀어나옴",
	},
	[PlayerType.PLAYER_KEEPER_B] = { 				-- EN: [OK] | RU: [OK] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_APOLLYON_B] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
	...
	[PlayerType.PLAYER_THEFORGOTTEN_B] = { 			-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [!] | KO_KR [OK] | PT_BR [OK]
		...
		pt_br = "Mate para ganhar orbitais de osso + segure o corpo para reuní-los",
	...
	[PlayerType.PLAYER_JACOB_B] = { 				-- EN: [OK] | RU: [ОК] | SPA: [X] | CS_CZ: [X] | PL: [X] | KO_KR [OK] | PT_BR [OK]
