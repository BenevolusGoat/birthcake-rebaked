...
if ModConfigMenu and not ModConfigMenu.GetCategoryIDByName("Birthcake") then
	ModConfigMenu.SetCategoryInfo("Birthcake", "Birthcake config settings")

	for i = 1, #SettingsHelper.Categories do
		ModConfigMenu.AddSpace("Birthcake", SettingsHelper.Categories[i])
	end
