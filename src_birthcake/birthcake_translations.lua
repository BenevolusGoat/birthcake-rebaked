...
local translations = {
	BIRTHCAKE_NAME = {
		...
		[PlayerType.PLAYER_ISAAC_B] = {				-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_MAGDALENE_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_CAIN_B] = {				-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_JUDAS_B] = {				-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Judas'",
			ru = "Порченого Иуды",
		...
		[PlayerType.PLAYER_BLUEBABY_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted ???'s",
			ru = "Порченого ???",
			spa = "de Tainted ???",
			cs_cz = "??? Poskvrněný",
		...
		[PlayerType.PLAYER_EVE_B] = {				-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Eve's",
			ru = "Порченой Евы",
			spa = "de Tainted Eva",
		...
		[PlayerType.PLAYER_SAMSON_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_AZAZEL_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_LAZARUS_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_EDEN_B] = {				-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_THELOST_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_LILITH_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_KEEPER_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_APOLLYON_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_BETHANY_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
		...
		[PlayerType.PLAYER_JACOB_B] = {				-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
