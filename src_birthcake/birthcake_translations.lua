...
local translations = {
	BIRTHCAKE_NAME = {
		...
		[PlayerType.PLAYER_ISAAC_B] = {				-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Isaac's",
			ru = "Исаака Порченый",
			spa = "de Tainted Isaac",
			cs_cz = "Izákův Poskvrněný",
			pl = "Izaaka Splamione",
			ko_kr = "아이작의 더럽혀진",
			pt_br = "do Isaque Contaminado",
		},
		[PlayerType.PLAYER_MAGDALENE_B] = {			-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Magdelene's",
			ru = "Магдалины Порченый",
			spa = "de Tainted Magdalena",
			cs_cz = "Magdalénin Poskvrněný",
			pl = "Magdaleny Splamione",
			ko_kr = "막달레나의 더럽혀진",
			pt_br = "da Madalena Contaminado",
		},
		[PlayerType.PLAYER_CAIN_B] = {				-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Cain's",
			ru = "Каина Порченый",
			spa = "de Tainted Caín",
			cs_cz = "Kainův Poskvrněný",
			pl = "Kaina Splamione",
			ko_kr = "카인의 더럽혀진",
			pt_br = "do Caim Contaminado",
		},
		[PlayerType.PLAYER_JUDAS_B] = {				-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Judas'",
			ru = "Иуды Порченый",
			spa = "de Tainted Judas",
			cs_cz = "Jidášův Poskvrněný",
			pl = "Judasza Splamione",
			ko_kr = "유다의 더럽혀진",
			pt_br = "do Judas Contaminado",
		},
		[PlayerType.PLAYER_BLUEBABY_B] = {			-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted ???'s",
			ru = "??? Порченый",
			spa = "de Tainted ???",
			cs_cz = "??? Poskvrněný",
		...
		[PlayerType.PLAYER_EVE_B] = {				-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Eve's",
			ru = "Евы Порченый",
			spa = "de Tainted Eva",
			cs_cz = "Evin Poskvrněný",
			pl = "Ewy Splamione",
			ko_kr = "이브의 더럽혀진",
			pt_br = "da Eva Contaminado",
		},
		[PlayerType.PLAYER_SAMSON_B] = {			-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Samson's",
			ru = "Самсона Порченый",
			spa = "de Tainted Sansón",
			cs_cz = "Samsonův Poskvrněný",
			pl = "Samsona Splamione",
			ko_kr = "삼손의 더럽혀진",
			pt_br = "do Sansão Contaminado",
		},
		[PlayerType.PLAYER_AZAZEL_B] = {			-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Azazel's",
			ru = "Азазеля Порченый",
			spa = "de Tainted Azazel",
			cs_cz = "Azazelův Poskvrněný",
			pl = "Azazela Splamione",
			ko_kr = "아자젤의 더럽혀진",
			pt_br = "do Azazel Contaminado",
		},
		[PlayerType.PLAYER_LAZARUS_B] = {			-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Lazarus'",
			ru = "Лазаря Порченый",
			spa = "de Tainted Lázaro",
			cs_cz = "Lazarův Poskvrněný",
			pl = "Łazarza Splamione",
			ko_kr = "나사로의 더럽혀진",
			pt_br = "do Lázaro Contaminado",
		},
		[PlayerType.PLAYER_EDEN_B] = {				-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Eden's",
			ru = "Эдема", --official name, but I'd use 2'nd variant "Иден Порченыйа"
			spa = "de Tainted Edén",
			cs_cz = "Edenův Poskvrněný",
			pl = "Edena Splamione",
			ko_kr = "에덴의 더럽혀진",
			pt_br = "do Éden Contaminado",
		},
		[PlayerType.PLAYER_THELOST_B] = {			-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Lost's",
			ru = "Потерянного Порченый",
			spa = "del Tainted Perdido",
			cs_cz = "Ztraceného Poskvrněný",
		...
		[PlayerType.PLAYER_LILITH_B] = {			-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Lilith's",
			ru = "Лилит Порченый",
			spa = "de Tainted Lilith",
			cs_cz = "Lilithin", -- Couldn't find a better translation, seems to be called like that in czech anyways t Poskvrněnýho
		...
		[PlayerType.PLAYER_BETHANY_B] = {			-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Bethany's",
			ru = "Вифании", --Бета Порченыйни
			spa = "de Tainted Bethany",
			cs_cz = "Betániin Poskvrněný",
			pl = "Betanii Splamione",
			ko_kr = "베타니의 더럽혀진",
			pt_br = "da Betânia Contaminado",
		},
		[PlayerType.PLAYER_JACOB_B] = {				-- EN: [OK] | RU: [!] | SPA: [OK] | CS_CZ: [!] | PL: [!] | KO_KR [!] | PT_BR [!]
			en_us = "Tainted Jacob's",
			ru = "Иакова Порченый",
			spa = "de Tainted Jacob",
			cs_cz = "Jákobův Poskvrněný",
			pl = "Jakuba Splamione",
			ko_kr = "야곱의 더럽혀진",
	...
	BIRTHCAKE_DESCRIPTION = {
		...
		[PlayerType.PLAYER_THELOST] = {				-- EN: [OK] | RU: [OK] | SPA: [OK] | CS_CZ: [X] | PL: [OK] | KO_KR [X] | PT_BR [X]
	...
	TAINTED_TITLES = {
		[PlayerType.PLAYER_ISAAC_B] = {				-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
			en_us = "The Broken's",
			spa = "Del Roto",
			cs_cz = "Zlomeného",
			ru = "Сломанного",
		...
		[PlayerType.PLAYER_MAGDALENE_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
		...
		[PlayerType.PLAYER_CAIN_B] = {				-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
			en_us = "The Hoarder's",
			spa = "Dell Acumulador",
			cs_cz = "Hromadiče",
		...
		[PlayerType.PLAYER_JUDAS_B] = {				-- EN: [OK] | RU: [OK] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
		...
		[PlayerType.PLAYER_BLUEBABY_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
			en_us = "The Soiled's",
			spa = "Del Sucio",
			cs_cz = "Zašpiněného",
			ru = "Грязного",
		...
		[PlayerType.PLAYER_EVE_B] = {				-- EN: [OK] | RU: [OK] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
			en_us = "The Curdled's",
		...
		[PlayerType.PLAYER_SAMSON_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [OK] | PL: [ОК] | KO_KR [X]
			en_us = "The Savage's",
			spa = "Del Salvaje",
			cs_cz = "Divocha",
			ru = "Дикаря",
		...
		[PlayerType.PLAYER_AZAZEL_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
		...
		[PlayerType.PLAYER_EDEN_B] = {				-- EN: [OK] | RU: [OK] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
		...
		[PlayerType.PLAYER_KEEPER_B] = {			-- EN: [OK] | RU: [OK] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
			en_us = "The Miser's",
			spa = "Del Avariento",
			cs_cz = "Skrblíka",
			ru = "Скупого",
		...
		[PlayerType.PLAYER_APOLLYON_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
			en_us = "The Empty's",
			spa = "de El Vacío",
			cs_cz = "Prázdného",
			ru = "Пустого",
		...
		[PlayerType.PLAYER_THEFORGOTTEN_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
		...
		[PlayerType.PLAYER_BETHANY_B] = {			-- EN: [OK] | RU: [ОК] | SPA: [OK] | CS_CZ: [OK] | PL: [OK] | KO_KR [X]
			en_us = "The Zealot's",
			spa = "da La Fanática",
			cs_cz = "Zfanatizované",
			ru = "Фанатички",
